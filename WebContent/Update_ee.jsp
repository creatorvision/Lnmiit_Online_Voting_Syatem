		...
		<section class="wrapper style4 special container 75%">
			...
			<div class="content">
				<form action="C_ceo.jsp" method="post">
					...
					<div class="row 50%">
						<div class="12u">
							<input type="time" name="starttime" placeholder="Start Time 24 hr format HH:MM:SS" />
						</div>
					</div>
					<div class="row 50%">
						<div class="12u">
							<input type="time" name="endtime" placeholder="End Time 24 hr format HH:MM:SS" />
						</div>
					</div>
					<div class="row 50%">
						<div class="12u">
