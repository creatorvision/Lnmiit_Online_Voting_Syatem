			...
			<div class="content">
				<form action="C_ceo.jsp" method="post">
					<div class="row 50%">
						<!--class= 6u 12u(mobile) -->
						<div class="12u">
							<input type="text" name="electionevent" placeholder="Event Name" />
						</div>
					</div>
					<div class="row 50%">
						<div class="12u">
					...
					<div class="row 50%">
						<div class="12u">
							<input type="time" id="starttime" name="starttime"
								placeholder="Start Time 24 hr format HH:MM:SS" />
						</div>
					</div>
					<div class="row 50%">
						<div class="12u">
							<input type="time" id="endtime" name="endtime"
								placeholder="End Time 24 hr format HH:MM:SS" />
						</div>
					</div>
					<div class="row 50%">
						<div class="12u">
					...
					<div class="row">
						<div class="12u">
							<ul class="buttons">
								<li><input type="submit" class="special" value="Create" onclick="checkForm()"/></li>
							</ul>
						</div>
					</div>
				</form>
